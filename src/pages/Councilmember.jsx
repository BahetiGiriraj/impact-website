...
const WEBSITE_TEAM = [
  ...
  },
  {
    ...
    avatarUrl: DarshanImg,
    linkedinUrl: "https://in.linkedin.com/in/darshan-dorik-07a300259",
  }
];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-row flex-nowrap justify-center gap-4">
            {WEBSITE_TEAM.map((member, index) => (
              <div key={index} className="flex justify-center w-1/5 min-w-0">
                <CompactCard
                  member={member}
                  index={index}
                />
